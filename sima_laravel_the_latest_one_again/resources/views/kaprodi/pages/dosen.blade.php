          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-header d-flex align-items-center justify-content-between">
                <span style="font-size:24px;font-weight: bold;color:white;">Dosen</span>
                <a href="/kaprodi?page=dosen&tr=1">
              ...
              <div class="table-responsive text-nowrap" style="max-height: 500px;overflow: auto;">
                ...
                <div>
                  <table border="1" cellpadding="10" cellspacing="0" class="table table-responsive" style="background:white;">
                    ...
                    <tbody>
                                ...
                                <td>
                                  <div>
                                    <div class="d-flex align-items-center gap-2 justify-content-end">
                                      <a href="/kaprodi?page=dosen&er=1&kr={{$item->nip}}">
                                        <button class="btn btn-secondary">Edit</button>
                                      </a>
                                      <form method="POST" action="/kaprodi?page=dosen">
                                        @csrf
                                        <input hidden name="mode" value="delete">
                                        <input hidden name="id" value="{{$item->nip}}">
                        ...
                        @empty
                            <tr>
                                <td colspan="4">No dosen found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                  </table>
                ...
                @else
                <div style="padding:20px;">Data dosen belum tersedia!</div>
                @endif
              </div>
            </div>
          </div>
      ...
      <div>
        <form method="POST" action="/kaprodi?page=dosen">
          ...
          <div style="padding:20px;padding-bottom:10px;padding-top:10px;">
            ...
            <input required class="form-control" placeholder="Masukan nip..." name="nip">
          </div>
          <div style="padding:20px;padding-bottom:10px;padding-top:10px;">
          ...
          <div style="padding:20px;">
            ...
            <a href="/kaprodi?page=dosen" class="btn btn-secondary">
              Batal
            </a>
          </div>
        </form>
    ...
    <div class="card_overlay">
      ...
      <div>
        <form method="POST" action="/kaprodi?page=dosen">
          ...
          <input hidden name="id" value="{{$toEdit->nip}}">
          <div style="padding:20px;padding-bottom:10px;padding-top:10px;">
            <div class="mb-1">Nip</div>
            <input required class="form-control" placeholder="Masukan nama lengkap..." name="nip" value="{{$toEdit->nip}}">
          </div>
          <div style="padding:20px;padding-bottom:10px;padding-top:10px;">
            <div class="mb-1">Nama Lengkap</div>
            <input required class="form-control" placeholder="Masukan nama lengkap..." name="nama" value="{{$toEdit->nama}}">
          </div>
          <div style="padding:20px;padding-bottom:10px;padding-top:10px;">
            <div class="mb-1">Fakultas</div>
            <select required class="form-control" name=id_fakultas onchange="show_opsi_prodi(this.value)">
