              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between flex-sm-row flex-column gap-3" style="width:100%;">
                    ...
                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between" style="width:100%;">
                      <div class="card-title">
                        <h5 class="text-nowrap mb-2" style="color:white">Jadwal Kuliah Pending</h5>
                      </div>
                      <div class="mt-sm-auto">
                        <h3 class="mb-0">{{$jadwal_pending}}</h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between flex-sm-row flex-column gap-3" style="width:100%;">
                    ...
                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between" style="width:100%;">
                      <div class="card-title">
                        <h5 class="text-nowrap mb-2" style="color:white">Jadwal Kuliah Disetujui</h5>
                      </div>
                      <div class="mt-sm-auto">
                        <h3 class="mb-0">{{$jadwal_approved}}</h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-sm-row flex-column gap-3">
                    ...
                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                      <div class="card-title">
                        <h5 class="text-nowrap mb-2" style="color:white">Jadwal Kuliah Ditolak</h5>
                      </div>
                      <div class="mt-sm-auto">
                        <h3 class="mb-0">{{$jadwal_rejected}}</h3>
                      </div>
                    </div>
                    <div id="profileReportChart"></div>
                  </div>
                ...
                <div class="card-body" style="padding:0 !important;">
                  <div class="d-flex flex-column" style="width:100%;">
                    <div class="card-title" style="margin-bottom:0;">
                      <h5 class="text-nowrap" style="color:white;margin: 0;padding:20px;">Alokasi Ruangan Perlu Ditinjau</h5>
                    </div>
