          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-header d-flex align-items-center justify-content-between">
                <span style="font-size:24px;font-weight: bold;color:white;">Program Studi</span>
                <a href="/akademik?page=program-studi&tr=1">
              ...
              <div class="table-responsive text-nowrap" style="max-height: 500px;overflow: auto;">
                                ...
                                <td>
                                  <div>
                                    <div class="d-flex align-items-center gap-2 justify-content-end">
                                      <form method="POST" action="/akademik?page=program-studi">
                                        @csrf
                                        <input hidden name="mode" value="delete">
                                        <input hidden name="id" value="{{$item->id_prodi}}">
                ...
                @else
                <div style="padding:20px;">Data program studi belum tersedia!</div>
                @endif
              </div>
            </div>
          </div>
      ...
      <div>
        <form method="POST" action="/akademik?page=program-studi">
          ...
          <div style="padding:20px;padding-bottom:0px;">
            <div class="mb-1">Nama Fakultas</div>
          ...
          <div style="padding:20px;padding-bottom:10px;">
            <div class="mb-1">Nama Program Studi</div>
            <input name="nama" required class="form-control" placeholder="Masukan nama program studi...">
          </div>
          <div style="padding:20px;">
            <button class="btn btn-primary">Simpan</button>
            <a href="/akademik?page=program-studi" class="btn btn-secondary">
              Batal
            </a>
          </div>
        </form>
        ...
        <form method="POST" action="/akademik?page=alokasi-ruangan">
          ...
          <div style="padding:20px;padding-bottom:10px;">
            ...
            <select required class="form-control" name=id_departemen>
              ...
              @if($toEdit->id_departemen === $item->id)
