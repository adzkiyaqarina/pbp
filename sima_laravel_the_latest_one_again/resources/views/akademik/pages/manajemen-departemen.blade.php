...
@section('title','SIMA: Manajemen Departemen')
@section('content')
<!-- Layout wrapper -->
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-header d-flex align-items-center justify-content-between">
                <span style="font-size:24px;font-weight: bold;color:white;">Manajemen Departemen</span>
                <a href="/akademik?page=manajemen-departemen&tr=1">
              ...
              <div class="table-responsive text-nowrap" style="max-height: 500px;overflow: auto;">
                                ...
                                <td>
                                  <div>
                                    <div class="d-flex align-items-center gap-2 justify-content-end">
                                      <a href="/akademik?page=manajemen-departemen&er=1&kr={{$item->id}}">
                                        <button class="btn btn-secondary">Edit</button>
                                      </a>
                                      <form method="POST" action="/akademik?page=manajemen-departemen">
                                        @csrf
                ...
                @else
                <div style="padding:20px;">Data departemen belum tersedia!</div>
                @endif
              </div>
            </div>
          </div>
      ...
      <div>
        <form method="POST" action="/akademik?page=manajemen-departemen">
          ...
          <div style="padding:20px;">
            ...
            <a href="/akademik?page=manajemen-departemen" class="btn btn-secondary">
              Batal
            </a>
          </div>
        </form>
