          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-header d-flex align-items-center justify-content-between">
                <span style="font-size:24px;font-weight: bold;color:white;">Fakultas</span>
                <a href="/akademik?page=fakultas&tr=1">
              ...
              <div class="table-responsive text-nowrap" style="max-height: 500px;overflow: auto;">
                                ...
                                <td>
                                  <div>
                                    <div class="d-flex align-items-center gap-2 justify-content-end">
                                      <form method="POST" action="/akademik?page=fakultas">
                                        @csrf
                                        <input hidden name="mode" value="delete">
                                        <input hidden name="id" value="{{$item->id_fakultas}}">
                ...
                @else
                <div style="padding:20px;">Data fakultas belum tersedia!</div>
                @endif
              </div>
            </div>
          </div>
      ...
      <div>
        <form method="POST" action="/akademik?page=fakultas">
          ...
          <div style="padding:20px;padding-bottom:10px;">
            ...
            <input class="form-control" name="nama" required placeholder="Masukan nama fakultas...">
          </div>
